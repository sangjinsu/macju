...
class Beer(models.Model):
    ...
    beer_type = models.ForeignKey('BeerType', models.DO_NOTHING, blank=True, null=True)
...
class Follow(models.Model):
    ...
    # following = models.ForeignKey('Member', models.DO_NOTHING, blank=True, null=True)
    # follow = models.ForeignKey('Member', models.DO_NOTHING, blank=True, null=True)
